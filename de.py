...
hikka_settings:
  ...
  inline_settings: "⚙️ <b>Hier kannst du die Hikka-Einstellungen verwalten</b>"
  ...
  _cls_doc: "Zusätzliche Hikka-Einstellungen"
  nonick_warning: "Achtung! Du hast NoNick mit dem Standardpräfix aktiviert! Du könntest in Hikka-Chats gemutet werden. Ändere das Präfix oder deaktiviere globales NoNick!"
  ...
  deauth_confirm: "⚠️ <b>Diese Aktion entfernt Hikka vollständig von diesem Konto! Dies kann nicht rückgängig gemacht werden</b>\n\n<i>- Alle mit Hikka verbundenen Chats werden gelöscht\n- Die Hikka-Sitzung wird zurückgesetzt\n- Der Inline-Bot von Hikka wird entfernt</i>"
  deauth_confirm_step2: "⚠️ <b>Bist du sicher, dass du Hikka entfernen möchtest?</b>"
  ...
  uninstall: "😢 <b>Hikka wird entfernt...</b>"
  uninstalled: "😢 <b>Hikka wurde entfernt. Die Web-Oberfläche ist weiterhin aktiv, und andere Konten können hinzugefügt werden!</b>"
  ...
  privacy_leak: "⚠️ <b>Dieser Befehl gewährt Zugriff auf die Hikka-Weboberfläche. Die Ausführung in öffentlichen Chats stellt ein Sicherheitsrisiko dar. Es wird empfohlen, dies in den <a href='tg://openmessage?user_id={}'>Gespeicherten Nachrichten</a> auszuführen. Führe</b> <code>{}proxypass force_insecure</code> <b>aus, um diese Warnung zu deaktivieren</b>"
  privacy_leak_nowarn: "⚠️ <b>Dieser Befehl gewährt Zugriff auf die Hikka-Weboberfläche. Die Ausführung in öffentlichen Chats stellt ein Sicherheitsrisiko dar. Es wird empfohlen, dies in den <a href='tg://openmessage?user_id={}'>Gespeicherten Nachrichten</a> auszuführen.</b>"
  opening_tunnel: "🔁 <b>Öffne Tunnel zur Hikka-Weboberfläche...</b>"
  ...
  btn_no: "🔻 Schließen"
  lavhost_web: "✌️ <b>Über diesen Link gelangst du zur Hikka-Weboberfläche auf lavHost</b>\n\n<i>💡 Du musst dich mit den bei der lavHost-Einrichtung angegebenen Daten anmelden</i>"
...
hikka_backup:
  ...
  saved: "✅ Häufigkeit gespeichert! Sie kann mit .set_backup_period geändert werden"
  never: "✅ Ich werde keine automatischen Sicherungen durchführen. Dies kann mit .set_backup_period rückgängig gemacht werden"
  invalid_args: "🚫 <b>Geben Sie die richtige Häufigkeit in Stunden an oder `0`, um sie zu deaktivieren</b>"
  backup_caption: '<emoji document_id=5469718869536940860>👆</emoji> <b>Dies ist Ihre Sicherung der Datenbank. Geben Sie sie niemandem, da sie persönliche Informationen enthält. Wenn Sie sie wiederherstellen müssen, verwenden Sie</b> <pre><code class="language-hikka">{prefix}restoredb</code></pre> <b>als Antwort auf diese Datei.</b>'
...
settings:
  ...
  <emoji document_id=5300777464820145682>🥳</emoji> Lassen Sie uns ein wenig über Argumente sprechen:
  
  <emoji document_id=5787313834012184077>🔐</emoji> Das Argument <code>--root</code> ermöglicht es Ihnen, Hikka als <b>Root-Benutzer</b> zu starten.
  
  <emoji document_id=5785209342986817408>🌎</emoji> Das Argument <code>--no-web</code> öffnet den Anmeldeprozess in Ihrem Konto <b>direkt im Terminal und nicht über den Link</b> <code>{}.lhr.life</code>.
  
  <emoji document_id=5471895949804575096>🤲</emoji> Wenn Sie jedoch von Hikka von hikariatama wechseln möchten, sollten Sie dieses Modul herunterladen:
  ...
  Es ist absolut sicher und hilft Ihnen, von Hikka auf Heroku zu wechseln.'
  ...
  unblacklisted: "<emoji document_id=5197474765387864959>👍</emoji> <b>Chat {} wurde von der Blacklist des Userbots entfernt</b>"
  user_blacklisted: "<emoji document_id=5197474765387864959>👍</emoji> <b>Benutzer {} wurde zur Blacklist des Userbots hinzugefügt</b>"
  user_unblacklisted: "<emoji document_id=5197474765387864959>👍</emoji> <b>Benutzer {} wurde von der Blacklist des Userbots entfernt</b>"
  what_prefix: "<emoji document_id=5382187118216879236>❓</emoji> <b>Welchen Präfix soll ich setzen?</b>"
  prefix_incorrect: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Der Präfix sollte nur aus einem Symbol bestehen</b>"
  prefix_set: "{} <b>Befehlspräfix aktualisiert. Verwenden Sie den folgenden Befehl, um es wieder zu ändern:</b>\n<pre><code class=\"language-hikka\">{newprefix}setprefix {oldprefix}</code></pre>"
  alias_created: "<emoji document_id=5197474765387864959>👍</emoji> <b>Alias erstellt. Verwenden Sie ihn durch</b> <code>{}</code>"
  aliases: "<b>🔗 Aliase:</b>\n"
  ...
  delalias_args: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Alias-Name erforderlich</b>"
  ...
  db_cleared: "<emoji document_id=5197474765387864959>👍</emoji> <b>Datenbank bereinigt</b>"
 ...
 Forked by <b>t.me/codrago</b>"
  _cls_doc: "Verwaltung grundlegender Einstellungen des Userbots"
  confirm_cleardb: "⚠️ <b>Sind Sie sicher, dass Sie die Datenbank zurücksetzen möchten?</b>"
  cleardb_confirm: "🗑 Datenbank bereinigen"
  cancel: "🚫 Abbrechen"
  who_to_blacklist: "<emoji document_id=5382187118216879236>❓</emoji> <b>Wen soll ich blockieren?</b>"
  who_to_unblacklist: "<emoji document_id=5382187118216879236>❓</emoji> <b>Wen soll ich entsperren?</b>"
  _cmd_doc_addalias: "Erstellen Sie einen Alias für einen Befehl"
  _cmd_doc_aliases: "Zeigt die Liste der Aliase an"
  _cmd_doc_blacklist: "[Chat] [Modul] - Bot irgendwo deaktivieren"
  _cmd_doc_blacklistuser: "[Benutzer] - Benutzer die Ausführung von Befehlen verbieten"
  _cmd_doc_cleardb: "Datenbank bereinigen"
  _cmd_doc_delalias: "Alias für Befehl entfernen"
  _cmd_doc_hikka: "Zeigt die Hikka-Version an"
  _cmd_doc_setprefix: "<Präfix> - Befehlspräfix festlegen"
  _cmd_doc_unblacklist: "[Chat] - Bot irgendwo aktivieren"
  _cmd_doc_unblacklistuser: "[Benutzer] - Benutzer die Ausführung von Befehlen erlauben"
...
inline_stuff:
  ...
  this_is_hikka: "🌘 <b>Hallo! Das ist Hikka — ein leistungsstarker modularer Telegram-Userbot. Du kannst ihn auf deinem Account installieren!</b>\n\n<b>🌍 <a href=\"https://github.com/coddrago/Hikka\">GitHub</a></b>\n<b>👥 <a href=\"https://t.me/heroku_talks\">Support-Chat</a></b>"
  _cmd_doc_ch_hikka_bot: "<Benutzername> - Ändert den Benutzernamen des Inline-Bots"

update_notifier:
  update_required: "🆕 <b>Es gibt ein Update für Hikka!</b>\n\nEine neue Version von Hikka wurde veröffentlicht.\n🔮 <b>Hikka <s>{}</s> -> {}</b>\n\n{}"
  more: "\n<i><b>🎥 Und noch {}...</b></i>"
  _cfg_doc_disable_notifications: "Benachrichtigungen über Updates deaktivieren"
  latest_disabled: "Benachrichtigungen über das letzte Update wurden deaktiviert"
  update: "🔄 Aktualisieren"
  ignore: "🚫 Ignorieren"
  changelog: '<emoji document_id=5434144690511290129>📰</emoji> <b>Änderungsprotokoll der letzten großen Aktualisierung:</b><pre><code class="language-hikka">{}</code></pre>'

updater:
  source: "<emoji document_id=5456255401194429832>📖</emoji> <b>Der Quellcode kann hier gelesen werden</b> <a href='{}'>hier</a>"
  restarting_caption: "<emoji document_id=5328274090262275771>🕗</emoji> <b>Dein {} wird neu gestartet...</b>"
  ...
  success: "<emoji document_id=5326015457155620929>⏱</emoji> <b>Neustart war erfolgreich! {}</b>\n<i>Aber Module werden noch geladen...</i>\n<i>Der Neustart dauerte {} Sekunden</i>"
  full_success: "<emoji document_id=5301096082674032190>👍</emoji> <b>Userbot vollständig neu geladen! {}</b>\n<i>Der vollständige Neustart dauerte {} Sekunden</i>"
  secure_boot_complete: "<emoji document_id=5472308992514464048>🔐</emoji> <b>Sicherer Start abgeschlossen! {}</b>\n<i>Der Neustart dauerte {} Sekunden</i>"
  origin_cfg_doc: "Die Quelle, von der Updates heruntergeladen werden"
  btn_restart: "🔄 Neustart"
  btn_update: "🧭 Aktualisieren"
  restart_confirm: "❓ <b>Bist du sicher, dass du neu starten möchtest?</b>"
  secure_boot_confirm: "❓ <b>Bist du sicher, dass du im sicheren Modus neu starten möchtest?</b>"
  update_confirm: "❓ <b>Bist du sicher, dass du das Update installieren möchtest?\n\n<a href=\"https://github.com/hikariatama/Hikka/commit/{}\">{}</a> ⤑ <a href=\"https://github.com/hikariatama/Hikka/commit/{}\">{}</a></b>"
  no_update: "🚸 <b>Du hast die neueste Version. Möchtest du trotzdem erzwingen, dass sie aktualisiert wird?</b>"
  cancel: "🚫 Abbrechen"
...
help:
  ...
  all_header: "<emoji document_id=5188377234380954537>🌘</emoji> <b>{} Module verfügbar, {} verborgen:</b>"
  no_mod: "🚫 <b>Gib das Modul(-e) an, das(-e) versteckt werden soll(en)</b>"
  hidden_shown: "<emoji document_id=5188377234380954537>🌘</emoji> <b>{} Module verborgen, {} Module angezeigt:</b>\n{}\n{}"
  support: "{} <b>Link zum</b> <a href='https://t.me/hikka_talks'>Hilfe-Chat</a></b>"
  ...
  not_exact: "<emoji document_id=5312383351217201533>☝️</emoji> <b>Es wurde keine exakte Übereinstimmung gefunden, daher wurde die passendste Auswahl getroffen</b>"
  request_join: "Du hast nach einem Link zum Hilfe-Chat von Hikka gefragt"
  core_notice: "<emoji document_id=5312383351217201533>☝️</emoji> <b>Dies ist ein eingebautes Modul. Du kannst es nicht entladen oder ersetzen</b>"
...
hikka_info:
  ...
  update_required: "<emoji document_id=5424728541650494040>😕</emoji> <b>Update erforderlich</b> <code>.update</code>"
...
loader:
  ...
  loadmod_not_allowed_fresh_pm: "<emoji document_id=5447644880824181073>⚠️</emoji> <b><u>Lesen Sie dies sorgfältig!</u></b> <emoji document_id=5447644880824181073>⚠️</emoji>\n\n<b>Sie versuchen, ein Modul in eine private Nachricht mit einem Benutzer zu laden, den Sie nicht kennen.</b> Module, die nicht vom Entwickler bestätigt wurden, können viele Probleme verursachen, von <b>Manipulationen mit Ihrem Konto bis hin zur Löschung des Kontos oder Kompromittierung der Sitzung</b>. Wenn Sie diesen Benutzer kennen und ihm <b><u>100%</u></b> vertrauen, warten Sie ein paar Tage und versuchen Sie es später erneut."
  ...
  file: "<emoji document_id=5433653135799228968>📁</emoji> <b>Datei</b> <code>{class_name}</code>\n\n<emoji document_id=5188377234380954537>🌘</emoji> <code>{prefix}lm</code> <b>als Antwort auf diese Nachricht, um zu installieren</b>\n\n{not_exact}"
  not_exact: "<emoji document_id=5312383351217201533>⚠️</emoji> <b>Keine genaue Übereinstimmung gefunden, daher wird das nächstgelegene Ergebnis angezeigt</b>"
  args: "<emoji document_id=5210952531676504517>❌</emoji> <b>Sie müssen Argumente angeben</b>"
  loadmod_confirm_pm_message: "<emoji document_id=5451732530048802485>⏳</emoji> <i>Warte auf Ihre Bestätigung...</i>"
  loadmod_cancelled: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Modulinstallation abgebrochen</b>"
  loadmod_confirm_pm: "⚠️ <b>Warnung!</b>\n\nDas Laden von Modulen aus unbekannten Quellen <b><u>ist sehr gefährlich</u></b> und kann zu <b>Kontolöschung oder Kompromittierung der Sitzung</b> führen. Stellen Sie sicher, dass Sie diesem Benutzer <b><u>100%</u></b> vertrauen.\n\n<b>Möchten Sie fortfahren und das Modul laden?</b>"
  ...
  no_module: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Modul im Repository nicht verfügbar.</b>"
  no_file: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Datei nicht gefunden</b>"
  provide_module: "<emoji document_id=5312383351217201533>⚠️</emoji> <b>Geben Sie das Modul zum Laden an</b>"
  bad_unicode: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Ungültige Modulkodierung</b>"
  load_failed: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Download fehlgeschlagen. Siehe Logs.</b>"
  loaded: "<emoji document_id=5188377234380954537>🌘</emoji> <b>Modul</b> <code>{}</code>{} <b>erfolgreich geladen {}</b>{}{}{}{}{}{}"
  ...
  all_modules_deleted: "<emoji document_id=5784993237412351403>✅</emoji> <b>Module gelöscht</b>"
  ...
  ffmpeg_required: "<emoji document_id=5454225457916420314>😖</emoji> <b>Dieses Modul erfordert FFMPEG, das nicht installiert ist</b>"
  developer: "\n\n<emoji document_id=5875452644599795072>🫶</emoji> <b>Entwickler:</b> {}"
  depends_from: "\n\n<emoji document_id=5431736674147114227>📦</emoji> <b>Abhängigkeiten:</b> \n{}"
  by: "von"
module_fs: "💿 <b>Willst du das Modul auf die Festplatte speichern, damit es beim Neustart nicht entladen wird?</b>"
save: "💿 Speichern"
no_save: "🚫 Nicht speichern"
save_for_all: "💽 Immer speichern"
never_save: "🚫 Niemals speichern"
will_save_fs: "💽 Jetzt werden alle Module, die aus einer Datei geladen werden, auf der Festplatte gespeichert"
inline_init_failed: "<emoji document_id=5454225457916420314>😖</emoji> <b>Dieses Modul benötigt HikkaInline, aber die Inline-Manager-Initialisierung ist fehlgeschlagen</b>\n<i>Versuche, einen der alten Bots im @BotFather zu löschen und den User-Bot neu zu starten</i>"
...
share_link_doc: "Gibt einen Link zum Modul nach dem Laden mit .dlmod an"
modlink: "\n\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Link:</b> <code>{}</code>"
blob_link: "\n\n<emoji document_id=5312383351217201533>⚠️</emoji> <b>Verwende keine `blob`-Links zum Laden von Modulen. Es ist besser, aus `raw` zu laden</b>"
raw_link: "\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Link:</b> <code>{}</code>"
suggest_subscribe: "\n\n⭐️ <b>Dieses Modul wurde von {} erstellt. Möchtest du es abonnieren, um den Entwickler zu unterstützen?</b>"
subscribe: "💬 Abonnieren"
no_subscribe: "🚫 Nicht abonnieren"
subscribed: "💬 Abonniert!"
unsubscribed: "🚫 Ich werde nicht mehr auffordern, diesen Kanal zu abonnieren"
confirm_clearmodules: "⚠️ <b>Bist du sicher, dass du alle Module entladen möchtest?</b>"
clearmodules: "🗑 Module entladen"
cancel: "🚫 Abbrechen"
overwrite_module: "<emoji document_id=5454225457916420314>😖</emoji> <b>Dieses Modul hat versucht, das eingebettete Modul (</b><code>{}</code><b>) zu überschreiben</b>\n\n<emoji document_id=5472146462362048818>💡</emoji><i> Dies ist kein Fehler, sondern eine Sicherheitsmaßnahme, um das Überschreiben eingebetteter Module mit unnötigem Kram zu verhindern. Melde es nicht im Support-Chat</i>"
overwrite_command: "<emoji document_id=5454225457916420314>😖</emoji> <b>Dieses Modul hat versucht, den eingebetteten Befehl (</b><code>{}</code><b>) zu überschreiben</b>\n\n<emoji document_id=5472146462362048818>💡</emoji><i> Dies ist kein Fehler, sondern eine Sicherheitsmaßnahme, um das Überschreiben von Befehlen eingebetteter Module mit unnötigem Kram zu verhindern. Melde es nicht im Support-Chat</i>"
unload_core: "<emoji document_id=5454225457916420314>😖</emoji> <b>Du kannst das eingebettete Modul</b> <code>{}</code><b> nicht entladen</b>\n\n<emoji document_id=5472146462362048818>💡</emoji><i> Dies ist keine Fehlermeldung, sondern eine Sicherheitsmaßnahme, um das Überschreiben eingebetteter Module zu verhindern. Melde es nicht im Support-Chat</i>"
cannot_unload_lib: "<emoji document_id=5454225457916420314>😖</emoji> <b>Du kannst diese Bibliothek nicht entladen</b>"
wait_channel_approve: "<emoji document_id=5469741319330996757>💫</emoji> <b>Das Modul</b> <code>{}</code> <b>fordert die Erlaubnis an, dem Kanal <a href=\"https://t.me/{}\">{}</a> beizutreten.</b>\n\n<b><emoji document_id=\"5467666648263564704\">❓</emoji> Grund: {}</b>\n\n<i>Warten auf <a href=\"https://t.me/{}\">Bestätigung</a>...</i>"
installing: "<emoji document_id=5325792861885570739>🕔</emoji> <b>Installiere Modul</b> <code>{}</code><b>...</b>"
...
no_repo: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Du musst ein Repository zum Hinzufügen angeben</b>"
...
translations:
  ...
  too_long: "<emoji document_id=5433653135799228968>📁</emoji> <b>Die Ausgabe des Befehls ist zu lang, daher wurde sie in einer Datei gesendet.</b>"
...
quickstart:
  base: "🌘🇩🇪 <b>Hallo.</b> Dein Userbot <b>Hikka</b> ist installiert.\n\n❓ <b>Brauchst du Hilfe?</b> Trete unserem Support-Chat bei. Wir helfen <b>jedem</b>.\n\n📼 <b>Du kannst nach Modulen suchen und sie mit </b><code>.heta</code><b> installieren. Gib einfach deine Suchanfrage ein und klicke auf ⛩ Install bei dem gewünschten Modul</b>\n\n📣 <b>Schau dir Kanäle mit von der Community erstellten Modulen an: <a href=\"https://t.me/hikka_ub/126\">zeigen</a></b>\n\n💁‍♀️ <b>Kurzanleitung:</b>\n\n1️⃣ <b>Schreib</b> <code>.help</code> <b>um eine Liste der Module zu sehen</b>\n2️⃣ <b>Schreib</b> <code>.help &lt;Modulname/Befehl&gt;</code> <b>um die Modulbeschreibung zu sehen</b>\n3️⃣ <b>Schreib</b> <code>.dlmod &lt;Link&gt;</code> <b>um ein Modul von einem Link zu laden</b>\n4️⃣ <b>Schreib</b> <code>.loadmod</code> <b>als Antwort auf eine Datei, um ein Modul aus der Datei zu laden</b>\n5️⃣ <b>Schreib</b> <code>.unloadmod &lt;Modulname&gt;</code> <b>um ein Modul zu entladen</b>\n\n💡 <b>Hikka unterstützt Module von Friendly-Telegram, GeekTG sowie eigene Module.</b>\n"
